...
export const EditForm = ({ id, name, dateBirth, bio, location }: EditFormProps) => {
  ...
  const { register, handleSubmit, formState: { errors },watch } = useForm<EditFormData>(
    {
      mode: "onSubmit",
  ...
  return (
    ...
    >
      ...
      <Button onPress={handleFileInputPress} >{isFileSelected?"Файл выбран":"Выберите файл"}</Button>
